                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="input-style-1">
                      ...
                      <input type="password"
                      required autocomplete="new-password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password" />
                    </div>
                  </div>
                  <!-- end col -->
                  ...
                  <div class="reg text-center mt-5">
                    <span>Already Registerd? &nbsp;<a href="{{ route('login') }}">Login</a></span>
                  </div>
                </div>
                <!-- end row -->
              </form>
